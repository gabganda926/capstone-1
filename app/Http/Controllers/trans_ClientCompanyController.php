...
{
	public function __construct(contactPersonConnection $contactPerson,inscompanyConnection $comp, addressConnection $add, personalInfoConnection $personalinfo,salesAgentConnection $salesA)
    {
        $this->company = $comp;
        $this->address = $add;
    ...
    {
      return view('/pages/transaction/accounting staff/clientCompany')
    ...
    public function ardelete_client_comp(Request $req)
    {
        ...
        {
            $comp = inscompanyConnection::where('comp_ID', '=', $ID)->first();
