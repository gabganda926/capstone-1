   ...
   <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="info-box-4 hover-zoom-effect animated bounceInDown" onclick="window.document.location='../admin/transaction/adm/claims';" style="cursor: pointer;">
                        <div class="icon">
            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card animated bounceInUp" onclick="window.document.location='../admin/transaction/adm/expiring-accounts';" style="cursor: pointer;">
