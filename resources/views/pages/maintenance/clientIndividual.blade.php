                ...
                <div class="modal-dialog modal-lg animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="emp_add" name = "emp_add" action = "individual/submit" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label><small>Sales Agent :</small></label>
                                                    <select id = "salesagent" name = "salesagent" class="form-control show-tick" readonly="true">
            ...
            <div class="collapse fade" id="largeModal" role="dialog">
                <div class="modal-dialog modal-lg animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'individual/update';
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'individual/delete';
