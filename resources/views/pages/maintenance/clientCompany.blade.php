                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <h3> <small><b>COMPANY INFORMATION</b></small></h3><br/>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group form-float">
                                                    <select id = "comp_sales_agent" name = "comp_sales_agent" class="form-control show-tick" readonly="true">
            ...
            <div class="collapse fade" id="largeModal" role="dialog">
                <div class="modal-dialog modal-lg animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'company/update';
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'company/delete';
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label><small>Sales Agent :</small></label>
                                                 <select id = "acomp_sales_agent" name = "acomp_sales_agent" class="form-control show-tick" readonly="true">
                                                  <option selected value = "" style = "display: none;">-- Select Sales Agent --</option>
                                                     @foreach($sales as $saleA)
                                                      @foreach($pInfo as $info)
                                                       @if($info->pinfo_ID == $saleA->personal_info_ID)
                                                       ...
                                                       @endif{{$info->pinfo_middle_name}}</option>
                                                       @endif
                                                      @endforeach
                                                     @endforeach
                                                 </select>
