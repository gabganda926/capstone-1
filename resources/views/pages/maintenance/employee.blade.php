                            ...
                            <form id="emp_view" name = "emp_view" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="float: right;">
                                    <div class="card">
                                        <div class="body">
                                            <div class="fallback">
                                                ...
                                                <input id = "apicture" name="apicture" type="file" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|images/*" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <label><small>Employee Type :</small></label>
                                        <select id = "aemp_type" name = "aemp_type" class="form-control show-tick" data-live-search="true">
                                          <option selected value = "" style = "display: none;">-- Select Job Title --</option>
                                          @foreach($emptype as $type)
                                            @if($type->del_flag == 0)
                                                <option value = "{{ $type->emptype_ID }}">{{ $type->emptype_Name }}</option>
                                            @else
                                                <option style = "display: none;" value = "{{ $type->emptype_ID }}">{{ $type->emptype_Name }}</option>
                                            @endif
                                          @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <label><small>Job Title :</small></label>
                                        <select id = "ajobtitle" name = "ajobtitle" class="form-control show-tick" data-live-search="true">
                                          <option selected value = "" style = "display: none;">-- Select Job Title --</option>
                                          @foreach($job as $title)
                                            @if($title->del_flag == 0)
                                                <option value = "{{ $title->jobtitle_ID }}">{{ $title->jobtitle_Name }}</option>
                                            @else
                                                <option style = "display: none;" value = "{{ $title->jobtitle_ID }}">{{ $title->jobtitle_Name }}</option>
                                            @endif
                                          @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                            <select id = "aadd_region" name = "aadd_region" class="form-control show-tick" data-live-search="true" disabled="disable">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <label><small>Employee Type :</small></label>
                                        <select id = "emp_type" name = "emp_type" class="form-control show-tick" data-live-search="true" >
                                          <option selected value = "" style = "display: none;">-- Select Employee Type --</option>
                                          @foreach($emptype as $type)
                                            @if($type->del_flag == 0)
                                                <option value = "{{ $type->emptype_ID }}">{{ $type->emptype_Name }}</option>
                                            @endif
                                    ...
                                    <div class="col-sm-6">
                                    <label><small>Job Title :</small></label>
                                        <select id = "jobtitle" name = "jobtitle" class="form-control show-tick" data-live-search="true" >
                                          <option selected value = "" style = "display: none;">-- Select Job Title --</option>
                                          @foreach($job as $title)
                                            @if($title->del_flag == 0)
                                                <option value = "{{ $title->jobtitle_ID }}">{{ $title->jobtitle_Name }}</option>
