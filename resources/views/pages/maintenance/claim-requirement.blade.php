              ...
              <div class="collapse fade" id="largeModal" role="dialog">
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        $('#schange').show();
                        $('#aclaimRequirement').prop('disabled', false);
                        $('#aclaimReq_type').prop('disabled', false);
                        $('#schange').html('SAVE CHANGES');
                          $( '#aCLAIM_type_name' ).focus();
                          swal({
                        ...
                        $('#schange').show();
                        $('#aclaimRequirement').prop('disabled', true);
                        $('#aclaimReq_type').prop('disabled', true);
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                      <div class="form-group form-float">
                                          <div class="form-line">
                                              <textarea id = "aclaimRequirement" name = "aclaimRequirement" rows="5" class="form-control no-resize auto-growth"></textarea>
                                              <label class="form-label">Claim Requirement </label>
                                          </div>
                                      </div>
                                    </div>
                                      ...
                                      @if($creq->del_flag == 0)
                                        @foreach($claimType as $ctype)
                                         @if($creq->claimReq_Type == $ctype->claimType_ID)
                                          <tr>
                                            <td><input type="checkbox" id="{{ $creq->claimReq_ID }}" class="filled-in chk-col-red checkCheckbox"/>
