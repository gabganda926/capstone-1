                                      ...
                                      @foreach($emprole as $role)
                                       @if($role->del_flag == 1)
                                          <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($role->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($cli->created_at)->format('l, h:i:s A').")" }}</td>
                                            <td>{{ \Carbon\Carbon::parse($role->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($cli->updated_at)->format('l, h:i:s A').")" }}</td>
                                            <td>
                                                <button type="button" class="rbutton btn bg-green waves-effect" data-toggle="tooltip" data-placement="left" title="Reactivate this sales agent" class="btn btn-success btn-xs waves-effect" 
