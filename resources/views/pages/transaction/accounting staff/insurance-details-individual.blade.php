...
@section('body')
    ...
    <button type="button" class="btn bg-teal waves-effect left" style="float: left; margin-left: 15px;" onclick="window.document.location='{{ URL::asset('admin/transaction/accounting-staff/insurance-expiring-accounts-individual') }}';"> <!-- BABALIK DAPAT SYA KUNG SAN SIYA GALING -->
