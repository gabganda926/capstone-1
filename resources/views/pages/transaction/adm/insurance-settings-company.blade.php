        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/insurance-notification-list-company') }}';" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <ol class="breadcrumb breadcrumb-bg-pink align-right">
                        ...
                        <li><a href="{{ URL::asset('admin/transaction/adm/insurance-expiring-accounts-company') }}"><i class="material-icons">library_books</i> Expiring Accounts (company)</a></li>
                        <li><a href="{{ URL::asset('admin/transaction/adm/insurance-notification-list-company') }}"><i class="material-icons">mail</i> Sent Notifications</a></li>
        ...
        <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <div class="card" id="acc">
                        <div class="header">
                        <h3> Settings </h3>
                        <p>Note: This system will automatically send notification to clients with expiring accounts. To automatically notify the client, please verify that internet connectivity is available.</p>
