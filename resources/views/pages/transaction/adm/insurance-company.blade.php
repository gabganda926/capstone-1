                    ...
                    <div class="card">
                        ...
                        <h3> Insurance Accounts - Company Client</h3>
                            <ul class="header-dropdown m-r--5">
                                <li><button type="button" class="btn bg-red waves-effect right" style="position: right;" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/insurance-expiring-accounts-company') }}';" data-toggle="tooltip" data-placement="bottom" title="View expiring accounts">
