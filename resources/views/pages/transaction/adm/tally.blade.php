                    ...
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        <th onclick="window.document.location='../../transaction/adm/tally-info';" style="cursor: pointer;">TL-10273-AB</th>
                                        <td onclick="window.document.location='../../transaction/adm/tally-info';" style="cursor: pointer;">Rola, Ma. Gabriella</td>
                                        <td onclick="window.document.location='../../transaction/adm/tally-info';" style="cursor: pointer;">March 05, 2017 (Saturday, 7:12:08PM)</td>
