        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/claim-request-online') }}';" >
                        <i class="material-icons">backspace</i><span style="font-size: 15px;"> BACK</span>
                    </button>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <ol class="breadcrumb breadcrumb-bg-pink align-right">
                        <li><a href="{{ URL::asset('admin/transaction/adm/claim-request-online') }}"><i class="material-icons">home</i> Home</a></li>
                        ...
                        <div class="list-group">
                            ...
                            <a href="javascript:void(0);" id="uploadDoc" class="list-group-item" onclick="
                                    ...
                                    $('body,html').animate({
                                                            ...
                                                            return false;
                                    ">4. Upload Claim Documents/Requirements</a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <div class="card" id="phDet">
                     ...
                     <div class="card" id="upDoc">
                        <div class="header">
                        <h3> IV. Upload Claim Documents/Requirements </h3>
                        <div class="divider" style="margin-bottom:20px;"></div>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary btn-block waves-effect" data-toggle="modal" data-target="">VIEW</button></td>
                                        </tr>
                                    </tbody>
                                </table>
