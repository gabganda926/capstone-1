        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/insurance-expiring-accounts-individual') }}';" >
                    ...
                    <div class="card">
                        ...
                        <h3> Sent Notifications </h3>
                            <ul class="header-dropdown m-r--5">
                                <li><button type="button" class="btn bg-gray waves-effect right" style="position: right;" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/insurance-settings-individual') }}';" data-toggle="tooltip" data-placement="bottom" title="Settings">
