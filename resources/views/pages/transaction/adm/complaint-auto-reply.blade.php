        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/adm/complaint-online') }}';" >
                        <i class="material-icons">backspace</i><span style="font-size: 15px;"> BACK</span>
                    </button>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <ol class="breadcrumb breadcrumb-bg-pink align-right">
                        <li><a href="{{ URL::asset('admin/transaction/adm/complaint-online') }}"><i class="material-icons">home</i> Home</a></li>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="body">
                        <div class="list-group">
                            <a href="javascript:void(0);" id="set" class="list-group-item active" onclick=" 
                                    $('#settings').show(800);
                                    $('#cRejected').hide(800);
                                    $('#cOngoing').hide(800);
                                    $('#cForwarded').hide(800);
                            ...
                            <a href="javascript:void(0);" id="cFor" class="list-group-item" onclick=" 
                                    ...
                                    $('body,html').animate({
                                                            ...
                                                            return false;
                                    ">
                                2. Content - When Forwarded to Manager
                            </a>
                            ...
                            <a href="javascript:void(0);" id="cOn" class="list-group-item" onclick=" 
                                    ...
                                    $('body,html').animate({
                                                            ...
                                                            return false;
                                    ">
                                4. Content - When action is ongoing
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="body">
                            <div class="card">
                                <div class="header bg-teal">
                                    <h2>
                                        Auto-reply Settings
                                        <label><small>NOTE: Upon forwarding the complaint to manager and rejecting a certain complaint, the system will automatically inform the complainant. In this module, you can edit the message that will be sent to the complainant. </small></label>
                                    </h2>
                                </div>
                                <div class="body">
                                    <form class="form">
