            ...
            <div class="header_top-sec">
                <div class="top_right">
                    <ul>
                        ...
                        <li class="@yield('complaint')"><a class="color7" href="/complaint/signin">Complaint</a></li>
                    </ul>
                </div>
                <div class="top_left">
                    <ul>
                        <li class="top_link">Customer Service Hotline:<a href="#">(02) 576-3781</a></li>|
                        <li class="top_link"><a href="/sign-in">Sign in</a></li>|                  
                    </ul>
                    <div class="social">
                        <ul>
    ...
    <div class="mega_nav">
         <div class="container">
             ...
             <ul class="megamenu skyblue">
                ...
                <li class="@yield('payment')"><a class="color7" href="/user/complaint/signin">Payment</a></li>
                <li class="@yield('claims')"><a class="color3" href="/claims">Claims</a></li>               
                <li class="@yield('transmittal')"><a class="color4" href="/transmittal/signin">Transmittal</a></li>
                <li class="@yield('endorsement')"><a class="color5" href="/endorsement/signin">Endorsement</a></li>
                <li class="@yield('monitor')"><a class="color6" href="#">Monitor</a>
                    <div class="megapanel">
                        <div class="row">
                            <div class="col1">
                                <div class="h_nav">
                                    <h4>DETAILS</h4>
                                    <ul>
                                        <li><a href="/monitor/payment/signin">Payment</a></li>
                                        <li><a href="/monitor/transmittal/signin">Transmittal</a></li>
                                        <li><a href="/monitor/claims/signin">Claims</a></li>
                                        <li><a href="/monitor/complaint/signin">Complaint</a></li>
                                        <li><a href="/monitor/endorsement/signin">Endorsement</a></li>                                
                                        <li><a href="/monitor/quotation/signin">Quotation</a></li>
                                    </ul>   
                                </div>                          
                            </div>
                        </div>
