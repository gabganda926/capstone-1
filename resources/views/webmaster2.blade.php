            ...
            <div class="header_top-sec">
                <div class="top_right">
                    <ul>
                        ...
                        <li class="@yield('complaint')"><a class="color7" href="/user/complaint/signin">Complaint</a></li>
                    </ul>
                </div>
                <div class="top_left">
                    <ul>
                        <li class="top_link"><a href="/sign-in">Welcome, Maria Gabriella</a></li>|                  
                    </ul>
                    <div class="social">
                        <ul>
    ...
    <div class="mega_nav">
         <div class="container">
             ...
             <ul class="megamenu skyblue">
                ...
                <li class="@yield('transmittal')"><a class="color4" href="/user/transmittal/signin">Transmittal</a></li>
                        ...
                        <div class="row">
                            <div class="col1">
                                <div class="h_nav">
                                    <h4>DETAILS</h4>
                                    <ul>
                                        <li><a href="/user/monitor/payment/signin">Payment</a></li>
                                        <li><a href="/user/monitor/transmittal/signin">Transmittal</a></li>
                                        <li><a href="/user/monitor/claims/signin">Claims</a></li>
                                        <li><a href="/user/monitor/complaint/signin">Complaint</a></li>
                                        <li><a href="/user/monitor/endorsement/signin">Endorsement</a></li>                                
                                        <li><a href="/user/monitor/quotation/signin">Quotation</a></li>
                                    </ul>   
                                </div>                          
                            </div>
                        </div>
