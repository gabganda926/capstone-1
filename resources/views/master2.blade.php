                    ...
                    <li class = "@yield('transQuote')">
                        ...
                        <ul class="ml-menu">
                            <li class = "@yield('transQuoteWalkin')">
                                <a href="/admin/transaction/accounting-staff/quotation-walkin">
                                    <span>Quotation - Walk in</span>
                                </a>
                            </li>

                            <li class = "@yield('transQuoteList')">
                                <a href="/admin/transaction/accounting-staff/quotation-list">
                    ...
                    <li class = "@yield('transIns')">
                        ...
                        <ul class="ml-menu">
                            <li class = "@yield('transInsInd')">
                                <a href="/admin/transaction/accounting-staff/insurance-individual">
                                    <span>Insurance Accounts - Individual</span>
                                </a>
                            </li>
                            <li class = "@yield('transInsComp')">
                                <a href="/admin/transaction/accounting-staff/insurance-company">
                                    <span>Insurance Accounts - Company</span>
                                </a>
                            </li>
                            <li class = "@yield('clientindividual')">
                                <a href="/admin/transaction/accounting-staff/client/individual">
                                    <span>New Client - Individual</span>
                                </a>
                            </li>
                            <li class = "@yield('clientcompany')">
                                <a href="/admin/transaction/accounting-staff/client/company">
                                    <span>New Client - Company</span>
                                </a>
                            </li>
                            <li class = "@yield('transNew')">
                                <a href="/admin/transaction/accounting-staff/insure-client">
                                    <span>Insure Account</span>
                                </a>
                            </li>
                            <li class = "@yield('transRenew')">
                                <a href="/admin/transaction/accounting-staff/renew-client">
                    ...
                    <li class = "@yield('transPayment')">
                        ...
                        <ul class="ml-menu">
                            <li class="@yield('transOnlinePayment')">
                                <a href="/admin/transaction/accounting-staff/payment-online">
                                    <span>Online Payment Requests</span>
                                </a>
                            </li>
                            <li class="@yield('transNewPayment')">
                                <a href="/admin/transaction/accounting-staff/payment-new">
                                    <span>Add New Payment</span>
                                </a>
                            </li>
                            <li class="@yield('transPaymentList')">
                                <a href="/admin/transaction/accounting-staff/payment">
